...
import { Listener } from "./utils/TypedEvent.js";
/**
...
export declare class Product extends Component {
    ...
    private _limitationOriginatorMin;
    /**
     * A read only array of the limitation originators for the minimum values.
     * @readonly
     * @type {CommandOriginator[]}
     */
    get LimitationOriginatorMin(): readonly CommandOriginator[];
    /**
     ...
     * @returns The limitation originator.
     */
    getLimitationOriginatorMin(functionalParameter: ParameterActive): CommandOriginator;
    private _limitationOriginatorMax;
    /**
     * A read only array of the limitation originators for the maximum values.
     * @readonly
     * @type {CommandOriginator[]}
     */
    get LimitationOriginatorMax(): readonly CommandOriginator[];
    /**
     ...
     * @returns The limitation originator.
     */
    getLimitationOriginatorMax(functionalParameter: ParameterActive): CommandOriginator;
     ...
     */
    getLimitationTime(functionalParameter: ParameterActive): number | undefined;
    private _limitationTimeRawMin;
    /**
     * A read only array of the limitation time raw values for the minimum value.
     * @readonly
     * @type {number[]}
     */
    get LimitationTimeRawMin(): readonly number[];
    /**
     ...
     * @returns The raw limitation time value.
     */
    getLimitationTimeRawMin(functionalParameter: ParameterActive): number;
    /**
     ...
     * @returns The limitation time in seconds or Infinity.
     */
    getLimitationTimeMin(functionalParameter: ParameterActive): number | undefined;
    private _limitationTimeRawMax;
    /**
     * A read only array of the limitation time raw values for the maximum value.
     * @readonly
     * @type {number[]}
     */
    get LimitationTimeRawMax(): readonly number[];
    /**
     ...
     * @returns The raw limitation time value.
     */
    getLimitationTimeRawMax(functionalParameter: ParameterActive): number;
    /**
     ...
     * @returns The limitation time in seconds or Infinity.
     */
    getLimitationTimeMax(functionalParameter: ParameterActive): number | undefined;
 ...
 * @class Products
 */
export declare class Products implements Disposable {
    readonly Connection: IConnection;
