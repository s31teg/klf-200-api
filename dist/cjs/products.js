...
const GW_COMMAND_REMAINING_TIME_NTF_js_1 = require("./KLF200-API/GW_COMMAND_REMAINING_TIME_NTF.js");
const GW_COMMAND_RUN_STATUS_NTF_js_1 = require("./KLF200-API/GW_COMMAND_RUN_STATUS_NTF.js");
const GW_COMMAND_SEND_REQ_js_1 = require("./KLF200-API/GW_COMMAND_SEND_REQ.js");
const GW_CS_SYSTEM_TABLE_UPDATE_NTF_js_1 = require("./KLF200-API/GW_CS_SYSTEM_TABLE_UPDATE_NTF.js");
const GW_ERROR_NTF_js_1 = require("./KLF200-API/GW_ERROR_NTF.js");
const GW_GET_ALL_NODES_INFORMATION_FINISHED_NTF_js_1 = require("./KLF200-API/GW_GET_ALL_NODES_INFORMATION_FINISHED_NTF.js");
const GW_GET_ALL_NODES_INFORMATION_NTF_js_1 = require("./KLF200-API/GW_GET_ALL_NODES_INFORMATION_NTF.js");
const GW_GET_ALL_NODES_INFORMATION_REQ_js_1 = require("./KLF200-API/GW_GET_ALL_NODES_INFORMATION_REQ.js");
const GW_GET_LIMITATION_STATUS_REQ_js_1 = require("./KLF200-API/GW_GET_LIMITATION_STATUS_REQ.js");
...
const GW_GET_STATE_CFM_js_1 = require("./KLF200-API/GW_GET_STATE_CFM.js");
const GW_GET_STATE_REQ_js_1 = require("./KLF200-API/GW_GET_STATE_REQ.js");
const GW_LIMITATION_STATUS_NTF_js_1 = require("./KLF200-API/GW_LIMITATION_STATUS_NTF.js");
const GW_NODE_INFORMATION_CHANGED_NTF_js_1 = require("./KLF200-API/GW_NODE_INFORMATION_CHANGED_NTF.js");
const GW_NODE_STATE_POSITION_CHANGED_NTF_js_1 = require("./KLF200-API/GW_NODE_STATE_POSITION_CHANGED_NTF.js");
const GW_SESSION_FINISHED_NTF_js_1 = require("./KLF200-API/GW_SESSION_FINISHED_NTF.js");
const GW_SET_LIMITATION_REQ_js_1 = require("./KLF200-API/GW_SET_LIMITATION_REQ.js");
const GW_SET_NODE_NAME_REQ_js_1 = require("./KLF200-API/GW_SET_NODE_NAME_REQ.js");
const GW_SET_NODE_ORDER_AND_PLACEMENT_REQ_js_1 = require("./KLF200-API/GW_SET_NODE_ORDER_AND_PLACEMENT_REQ.js");
const GW_SET_NODE_VARIATION_REQ_js_1 = require("./KLF200-API/GW_SET_NODE_VARIATION_REQ.js");
const GW_STATUS_REQUEST_NTF_js_1 = require("./KLF200-API/GW_STATUS_REQUEST_NTF.js");
const GW_STATUS_REQUEST_REQ_js_1 = require("./KLF200-API/GW_STATUS_REQUEST_REQ.js");
const GW_SYSTEMTABLE_DATA_js_1 = require("./KLF200-API/GW_SYSTEMTABLE_DATA.js");
const GW_WINK_SEND_REQ_js_1 = require("./KLF200-API/GW_WINK_SEND_REQ.js");
...
const debug = (0, debug_1.default)(`klf-200-api:products`);
/**
 ...
 * @class Product
 */
class Product extends PropertyChangedEvent_js_1.Component {
    Connection;
    _name;
    /**
    ...
    _runStatus = GW_COMMAND_js_1.RunStatus.ExecutionCompleted;
    _statusReply = GW_COMMAND_js_1.StatusReply.Unknown;
    ...
    constructor(Connection, frame) {
        ...
        this._limitationOriginator = new Array(17).fill(GW_COMMAND_js_1.CommandOriginator.User);
        this._limitationOriginatorMin = new Array(17).fill(GW_COMMAND_js_1.CommandOriginator.User);
        this._limitationOriginatorMax = new Array(17).fill(GW_COMMAND_js_1.CommandOriginator.User);
        this._limitationTimeRaw = new Array(17).fill(GW_COMMAND_js_1.LockTime.lockTimeTolockTimeValueForLimitation(Infinity));
        this._limitationTimeRawMin = new Array(17).fill(GW_COMMAND_js_1.LockTime.lockTimeTolockTimeValueForLimitation(Infinity));
        this._limitationTimeRawMax = new Array(17).fill(GW_COMMAND_js_1.LockTime.lockTimeTolockTimeValueForLimitation(Infinity));
        this._disposables.use(this.Connection.on(async (frame) => {
            ...
            common_js_1.GatewayCommand.GW_NODE_INFORMATION_CHANGED_NTF,
            common_js_1.GatewayCommand.GW_NODE_STATE_POSITION_CHANGED_NTF,
            common_js_1.GatewayCommand.GW_COMMAND_RUN_STATUS_NTF,
            common_js_1.GatewayCommand.GW_COMMAND_REMAINING_TIME_NTF,
            common_js_1.GatewayCommand.GW_GET_NODE_INFORMATION_NTF,
            common_js_1.GatewayCommand.GW_STATUS_REQUEST_NTF,
        ]));
    }
    [Symbol.dispose]() {
    ...
    async setNameAsync(newName) {
        ...
        const confirmationFrame = await this.Connection.sendFrameAsync(new GW_SET_NODE_NAME_REQ_js_1.GW_SET_NODE_NAME_REQ(this.NodeID, newName));
    ...
    get Category() {
        switch (this.TypeID) {
            case GW_SYSTEMTABLE_DATA_js_1.ActuatorType.VenetianBlind:
                return "Interior venetian blind";
            case GW_SYSTEMTABLE_DATA_js_1.ActuatorType.RollerShutter:
                switch (this.SubType) {
                    case 1:
            ...
            case GW_SYSTEMTABLE_DATA_js_1.ActuatorType.Awning:
                return "Vertical exterior awning";
            case GW_SYSTEMTABLE_DATA_js_1.ActuatorType.WindowOpener:
                switch (this.SubType) {
                    case 1:
            ...
            case GW_SYSTEMTABLE_DATA_js_1.ActuatorType.GarageOpener:
                return "Garage door opener";
            case GW_SYSTEMTABLE_DATA_js_1.ActuatorType.Light:
                return "Light";
            case GW_SYSTEMTABLE_DATA_js_1.ActuatorType.GateOpener:
                return "Gate opener";
            case GW_SYSTEMTABLE_DATA_js_1.ActuatorType.Lock:
                switch (this.SubType) {
                    case 1:
                        return "Window lock";
                    default:
            ...
            case GW_SYSTEMTABLE_DATA_js_1.ActuatorType.Blind:
                return "Vertical interior blind";
            case GW_SYSTEMTABLE_DATA_js_1.ActuatorType.DualShutter:
                return "Dual roller shutter";
            case GW_SYSTEMTABLE_DATA_js_1.ActuatorType.OnOffSwitch:
                return "On/Off switch";
            case GW_SYSTEMTABLE_DATA_js_1.ActuatorType.HorizontalAwning:
                return "Horizontal awning";
            case GW_SYSTEMTABLE_DATA_js_1.ActuatorType.ExternalVentianBlind:
                return "Exterior venetion blind";
            case GW_SYSTEMTABLE_DATA_js_1.ActuatorType.LouvreBlind:
                return "Louvre blind";
            case GW_SYSTEMTABLE_DATA_js_1.ActuatorType.CurtainTrack:
                return "Curtain track";
            case GW_SYSTEMTABLE_DATA_js_1.ActuatorType.VentilationPoint:
                switch (this.SubType) {
                    case 1:
                        return "Air inlet";
                    case 2:
            ...
            case GW_SYSTEMTABLE_DATA_js_1.ActuatorType.ExteriorHeating:
                return "Exterior heating";
            case GW_SYSTEMTABLE_DATA_js_1.ActuatorType.SwingingShutter:
                switch (this.SubType) {
                    case 1:
    ...
    async setNodeVariationAsync(newNodeVariation) {
        ...
        const confirmationFrame = await this.Connection.sendFrameAsync(new GW_SET_NODE_VARIATION_REQ_js_1.GW_SET_NODE_VARIATION_REQ(this.NodeID, newNodeVariation));
        if (confirmationFrame.Status === common_js_1.GW_COMMON_STATUS.SUCCESS) {
    ...
    async setOrderAndPlacementAsync(newOrder, newPlacement) {
        ...
        const confirmationFrame = await this.Connection.sendFrameAsync(new GW_SET_NODE_ORDER_AND_PLACEMENT_REQ_js_1.GW_SET_NODE_ORDER_AND_PLACEMENT_REQ(this.NodeID, newOrder, newPlacement));
        if (confirmationFrame.Status === common_js_1.GW_COMMON_STATUS.SUCCESS) {
     ...
     */
    get CurrentPosition() {
        return (0, GW_COMMAND_js_1.convertPositionRaw)(this._currentPositionRaw, this.TypeID);
    }
    /**
    ...
    async setTargetPositionRawAsync(newPosition, PriorityLevel = 3, CommandOriginator = 1, ParameterActive = 0, FunctionalParameters = [], PriorityLevelLock = 0, PriorityLevels = [], LockTime = Infinity) {
        ...
        const req = new GW_COMMAND_SEND_REQ_js_1.GW_COMMAND_SEND_REQ(this.NodeID, newPosition, PriorityLevel, CommandOriginator, ParameterActive, FunctionalParameters, PriorityLevelLock, PriorityLevels, LockTime);
        const confirmationFrame = await this.Connection.sendFrameAsync(req);
        if (confirmationFrame.CommandStatus === GW_COMMAND_js_1.CommandStatus.CommandAccepted) {
    ...
    async setTargetPositionAsync(newPosition, PriorityLevel = 3, CommandOriginator = 1, ParameterActive = 0, FunctionalParameters = [], PriorityLevelLock = 0, PriorityLevels = [], LockTime = Infinity) {
        ...
        return await this.setTargetPositionRawAsync((0, GW_COMMAND_js_1.convertPosition)(newPosition, this.TypeID), PriorityLevel, CommandOriginator, ParameterActive, FunctionalParameters, PriorityLevelLock, PriorityLevels, LockTime);
    }
    /**
     ...
     */
    get TargetPosition() {
        return (0, GW_COMMAND_js_1.convertPositionRaw)(this._targetPositionRaw, this.TypeID);
    }
    ...
    getLimitationTime(functionalParameter) {
        return GW_COMMAND_js_1.LockTime.lockTimeValueToLockTimeForLimitation(this.getLimitationTimeRaw(functionalParameter));
    }
    ...
    getLimitationTimeMin(functionalParameter) {
        return GW_COMMAND_js_1.LockTime.lockTimeValueToLockTimeForLimitation(this.getLimitationTimeRawMin(functionalParameter));
    }
    ...
    getLimitationTimeMax(functionalParameter) {
        return GW_COMMAND_js_1.LockTime.lockTimeValueToLockTimeForLimitation(this.getLimitationTimeRawMax(functionalParameter));
    }
    _limitationMinRaw;
    /**
    ...
    getLimitations(functionalParameter) {
        const limitationMin = (0, GW_COMMAND_js_1.convertPositionRaw)(this.getLimitationMinRaw(functionalParameter), this.TypeID);
        const limitationMax = (0, GW_COMMAND_js_1.convertPositionRaw)(this.getLimitationMaxRaw(functionalParameter), this.TypeID);
    ...
    async stopAsync(PriorityLevel = 3, CommandOriginator = 1, ParameterActive = 0, FunctionalParameters = [], PriorityLevelLock = 0, PriorityLevels = [], LockTime = Infinity) {
        ...
        const confirmationFrame = await this.Connection.sendFrameAsync(new GW_COMMAND_SEND_REQ_js_1.GW_COMMAND_SEND_REQ(this.NodeID, 0xd200, PriorityLevel, CommandOriginator, ParameterActive, FunctionalParameters, PriorityLevelLock, PriorityLevels, LockTime));
        if (confirmationFrame.CommandStatus === GW_COMMAND_js_1.CommandStatus.CommandAccepted) {
    ...
    async winkAsync(EnableWink = true, WinkTime = 254, PriorityLevel = 3, CommandOriginator = 1) {
        ...
        const confirmationFrame = await this.Connection.sendFrameAsync(new GW_WINK_SEND_REQ_js_1.GW_WINK_SEND_REQ(this.NodeID, EnableWink, WinkTime, PriorityLevel, CommandOriginator));
        if (confirmationFrame.Status === common_js_1.GW_INVERSE_STATUS.SUCCESS) {
    ...
    async refreshAsync() {
        ...
        const confirmationFrame = await this.Connection.sendFrameAsync(new GW_GET_NODE_INFORMATION_REQ_js_1.GW_GET_NODE_INFORMATION_REQ(this.NodeID));
        if (confirmationFrame.Status === common_js_1.GW_COMMON_STATUS.SUCCESS) {
    ...
    setupWaitForLimitationFinished(sessionID, limitationType, parameterActive, resolve, reject) {
        ...
        const dispose = this.Connection.on(async (frame) => {
            try {
                ...
                if (frame instanceof GW_LIMITATION_STATUS_NTF_js_1.GW_LIMITATION_STATUS_NTF && frame.SessionID === sessionID) {
                    ...
                    if (limitationTypes.indexOf(GW_COMMAND_js_1.LimitationType.MinimumLimitation) !== -1) {
                    ...
                    if (limitationTypes.indexOf(GW_COMMAND_js_1.LimitationType.MaximumLimitation) !== -1) {
                ...
                else if (frame instanceof GW_SESSION_FINISHED_NTF_js_1.GW_SESSION_FINISHED_NTF && frame.SessionID === sessionID) {
        ...
        }, [common_js_1.GatewayCommand.GW_LIMITATION_STATUS_NTF, common_js_1.GatewayCommand.GW_SESSION_FINISHED_NTF]);
        return dispose;
    }
    /**
     ...
     * @returns Promise<void>
     */
    async refreshLimitationAsync(limitationType, parameterActive = GW_COMMAND_js_1.ParameterActive.MP) {
        ...
        try {
            ...
            const frameToSend = new GW_GET_LIMITATION_STATUS_REQ_js_1.GW_GET_LIMITATION_STATUS_REQ(this.NodeID, limitationType, parameterActive);
            ...
            const waitForSessionFinishedNtfPromise = new Promise((res, rej) => {
                try {
                    stack.use(this.Connection.on((frame) => {
                        ...
                        if (frame instanceof GW_SESSION_FINISHED_NTF_js_1.GW_SESSION_FINISHED_NTF && frame.SessionID === frameToSend.SessionID) {
     ...
     * @returns Promise<void>
     */
    async setLimitationRawAsync(minValue, maxValue, parameterActive = GW_COMMAND_js_1.ParameterActive.MP, limitationTime = 253, // Unlimited time
    commandOriginator = GW_COMMAND_js_1.CommandOriginator.SAAC, priorityLevel = GW_COMMAND_js_1.PriorityLevel.ComfortLevel2) {
        ...
        const frameToSend = new GW_SET_LIMITATION_REQ_js_1.GW_SET_LIMITATION_REQ(this.NodeID, minValue, maxValue, limitationTime, priorityLevel, commandOriginator, parameterActive);
        this.setupWaitForLimitationFinished(frameToSend.SessionID, [GW_COMMAND_js_1.LimitationType.MinimumLimitation, GW_COMMAND_js_1.LimitationType.MaximumLimitation], parameterActive, resolve, reject);
        const confirmationFrame = await this.Connection.sendFrameAsync(frameToSend);
        if (confirmationFrame.Status === common_js_1.GW_INVERSE_STATUS.SUCCESS) {
            await waitForLimitationFinishedPromise;
     ...
     * @returns Promise<void>
     */
    async setLimitationAsync(minValue, maxValue, parameterActive = GW_COMMAND_js_1.ParameterActive.MP, limitationTime = Infinity, // Unlimited time
    commandOriginator = GW_COMMAND_js_1.CommandOriginator.SAAC, priorityLevel = GW_COMMAND_js_1.PriorityLevel.ComfortLevel2) {
        ...
        let rawMinValue = (0, GW_COMMAND_js_1.convertPosition)(minValue, this.TypeID);
        let rawMaxValue = (0, GW_COMMAND_js_1.convertPosition)(maxValue, this.TypeID);
        const rawLimitationTime = GW_COMMAND_js_1.LockTime.lockTimeTolockTimeValueForLimitation(limitationTime);
     ...
     * @returns Promise<void>
     */
    async clearLimitationAsync(parameterActive = GW_COMMAND_js_1.ParameterActive.MP, commandOriginator = GW_COMMAND_js_1.CommandOriginator.SAAC, priorityLevel = GW_COMMAND_js_1.PriorityLevel.ComfortLevel2) {
    ...
    async onNotificationHandler(frame) {
        ...
        if (typeof this === "undefined")
            return;
        if (frame instanceof GW_NODE_INFORMATION_CHANGED_NTF_js_1.GW_NODE_INFORMATION_CHANGED_NTF) {
            await this.onNodeInformationChanged(frame);
        }
        else if (frame instanceof GW_NODE_STATE_POSITION_CHANGED_NTF_js_1.GW_NODE_STATE_POSITION_CHANGED_NTF) {
            await this.onNodeStatePositionChanged(frame);
        }
        else if (frame instanceof GW_COMMAND_RUN_STATUS_NTF_js_1.GW_COMMAND_RUN_STATUS_NTF) {
            await this.onRunStatus(frame);
        }
        else if (frame instanceof GW_COMMAND_REMAINING_TIME_NTF_js_1.GW_COMMAND_REMAINING_TIME_NTF) {
            await this.onRemainingTime(frame);
        }
        else if (frame instanceof GW_GET_NODE_INFORMATION_NTF_js_1.GW_GET_NODE_INFORMATION_NTF) {
            await this.onGetNodeInformation(frame);
        }
        else if (frame instanceof GW_STATUS_REQUEST_NTF_js_1.GW_STATUS_REQUEST_NTF) {
    ...
    async onRunStatus(frame) {
        ...
        if (frame.NodeID === this.NodeID) {
            switch (frame.NodeParameter) {
                case GW_COMMAND_js_1.ParameterActive.MP:
    ...
    async onRemainingTime(frame) {
        ...
        if (frame.NodeID === this.NodeID &&
            frame.NodeParameter === GW_COMMAND_js_1.ParameterActive.MP &&
...
class Products {
    Connection;
    _onNewProduct = new TypedEvent_js_1.TypedEvent();
    _onRemovedProduct = new TypedEvent_js_1.TypedEvent();
    /**
        ...
        try {
            ...
            const dispose = __addDisposableResource(env_2, this.Connection.on((frame) => {
                try {
                    ...
                    if (frame instanceof GW_GET_ALL_NODES_INFORMATION_NTF_js_1.GW_GET_ALL_NODES_INFORMATION_NTF) {
                        const newProduct = new Product(this.Connection, frame);
                        this.Products[frame.NodeID] = newProduct;
                    }
                    else if (frame instanceof GW_GET_ALL_NODES_INFORMATION_FINISHED_NTF_js_1.GW_GET_ALL_NODES_INFORMATION_FINISHED_NTF) {
                        this._disposables.use(this.Connection.on(async (frame) => {
                            ...
                            await this.onNotificationHandler(frame);
                        }, [common_js_1.GatewayCommand.GW_CS_SYSTEM_TABLE_UPDATE_NTF]));
                        resolve();
                    }
                }
                catch (error) {
            ...
            }, [common_js_1.GatewayCommand.GW_GET_ALL_NODES_INFORMATION_NTF, common_js_1.GatewayCommand.GW_GET_ALL_NODES_INFORMATION_FINISHED_NTF]), false);
            const getAllNodesInformation = await this.Connection.sendFrameAsync(new GW_GET_ALL_NODES_INFORMATION_REQ_js_1.GW_GET_ALL_NODES_INFORMATION_REQ());
            if (getAllNodesInformation.Status !== common_js_1.GW_COMMON_STATUS.SUCCESS) {
                if (getAllNodesInformation.Status !== common_js_1.GW_COMMON_STATUS.ERROR /* No nodes available -> not a real error */) {
            ...
            if (getAllNodesInformation.NumberOfNode > 0) {
                ...
                for (const product of this.Products) {
                    if (product) {
                        ...
                        await product.refreshLimitationAsync(GW_COMMAND_js_1.LimitationType.MinimumLimitation);
                        await product.refreshLimitationAsync(GW_COMMAND_js_1.LimitationType.MaximumLimitation);
                    }
                }
            }
    ...
    async onNotificationHandler(frame) {
        ...
        if (frame instanceof GW_CS_SYSTEM_TABLE_UPDATE_NTF_js_1.GW_CS_SYSTEM_TABLE_UPDATE_NTF) {
            // Remove nodes
            ...
            if (frame.AddedNodes.length > 0) {
                ...
                const checkForIdle = async () => {
                    ...
                    try {
                        const getStateCfm = await this.Connection.sendFrameAsync(new GW_GET_STATE_REQ_js_1.GW_GET_STATE_REQ());
                        return (getStateCfm.GatewayState === GW_GET_STATE_CFM_js_1.GatewayState.GatewayMode_WithActuatorNodes &&
                            getStateCfm.GatewaySubState === GW_GET_STATE_CFM_js_1.GatewaySubState.Idle);
                    }
                    catch (error) {
                        if (error instanceof Error &&
                            error.cause instanceof GW_ERROR_NTF_js_1.GW_ERROR_NTF &&
                            error.cause.ErrorNumber === GW_ERROR_NTF_js_1.GW_ERROR.Busy) {
                ...
                const waitForIdle = async () => {
                    if (!(await checkForIdle())) {
                        await (0, promises_1.setImmediate)(await waitForIdle());
                    }
                };
    ...
    async addNodeAsync(nodeID) {
        ...
        try {
            ...
            const retryIfNotBusy = async () => {
                ...
                try {
                    const getNodeInformation = await this.Connection.sendFrameAsync(new GW_GET_NODE_INFORMATION_REQ_js_1.GW_GET_NODE_INFORMATION_REQ(nodeID));
                    ...
                    if (error instanceof Error &&
                        error.cause instanceof GW_ERROR_NTF_js_1.GW_ERROR_NTF &&
                        error.cause.ErrorNumber === GW_ERROR_NTF_js_1.GW_ERROR.Busy) {
                        return await (0, promises_1.setImmediate)(await retryIfNotBusy());
                    }
                    debug(`Error reading node information of added node: ${error}`);
                    throw error;
                }
            };
            const getNodeInformation = await (0, promises_1.setImmediate)(await retryIfNotBusy());
            if (getNodeInformation.Status !== common_js_1.GW_COMMON_STATUS.SUCCESS) {
    ...
    async requestStatusAsync(Nodes, StatusType, FunctionalParameters = []) {
        ...
        const confirmationFrame = await this.Connection.sendFrameAsync(new GW_STATUS_REQUEST_REQ_js_1.GW_STATUS_REQUEST_REQ(Nodes, StatusType, FunctionalParameters));
        if (confirmationFrame.CommandStatus === GW_COMMAND_js_1.CommandStatus.CommandAccepted) {
