...
const GW_GET_NETWORK_SETUP_REQ_js_1 = require("./KLF200-API/GW_GET_NETWORK_SETUP_REQ.js");
const GW_GET_PROTOCOL_VERSION_REQ_js_1 = require("./KLF200-API/GW_GET_PROTOCOL_VERSION_REQ.js");
const GW_GET_STATE_REQ_js_1 = require("./KLF200-API/GW_GET_STATE_REQ.js");
const GW_GET_VERSION_REQ_js_1 = require("./KLF200-API/GW_GET_VERSION_REQ.js");
const GW_HOUSE_STATUS_MONITOR_DISABLE_REQ_js_1 = require("./KLF200-API/GW_HOUSE_STATUS_MONITOR_DISABLE_REQ.js");
const GW_HOUSE_STATUS_MONITOR_ENABLE_REQ_js_1 = require("./KLF200-API/GW_HOUSE_STATUS_MONITOR_ENABLE_REQ.js");
const GW_LEAVE_LEARN_STATE_REQ_js_1 = require("./KLF200-API/GW_LEAVE_LEARN_STATE_REQ.js");
const GW_PASSWORD_CHANGE_REQ_js_1 = require("./KLF200-API/GW_PASSWORD_CHANGE_REQ.js");
const GW_REBOOT_REQ_js_1 = require("./KLF200-API/GW_REBOOT_REQ.js");
const GW_RTC_SET_TIME_ZONE_REQ_js_1 = require("./KLF200-API/GW_RTC_SET_TIME_ZONE_REQ.js");
const GW_SET_FACTORY_DEFAULT_REQ_js_1 = require("./KLF200-API/GW_SET_FACTORY_DEFAULT_REQ.js");
const GW_SET_NETWORK_SETUP_REQ_js_1 = require("./KLF200-API/GW_SET_NETWORK_SETUP_REQ.js");
const GW_SET_UTC_REQ_js_1 = require("./KLF200-API/GW_SET_UTC_REQ.js");
const common_js_1 = require("./KLF200-API/common.js");
const debug = (0, debug_1.default)(`klf-200-api:gateway`);
/**
...
class Gateway {
    ...
    async changePasswordAsync(oldPassword, newPassword) {
        ...
        const passwordChanged = await this.connection.sendFrameAsync(new GW_PASSWORD_CHANGE_REQ_js_1.GW_PASSWORD_CHANGE_REQ(oldPassword, newPassword));
        return passwordChanged.Status === common_js_1.GW_COMMON_STATUS.SUCCESS;
    }
    /**
    ...
    async getVersionAsync() {
        ...
        const versionInformation = await this.connection.sendFrameAsync(new GW_GET_VERSION_REQ_js_1.GW_GET_VERSION_REQ());
        return {
    ...
    async getProtocolVersionAsync() {
        ...
        const versionInformation = await this.connection.sendFrameAsync(new GW_GET_PROTOCOL_VERSION_REQ_js_1.GW_GET_PROTOCOL_VERSION_REQ());
        return {
    ...
    async getStateAsync() {
        ...
        const state = await this.connection.sendFrameAsync(new GW_GET_STATE_REQ_js_1.GW_GET_STATE_REQ());
        return {
    ...
    async setUTCDateTimeAsync(utcTimestamp = new Date()) {
        ...
        await this.connection.sendFrameAsync(new GW_SET_UTC_REQ_js_1.GW_SET_UTC_REQ(utcTimestamp));
    }
    /**
    ...
    async setTimeZoneAsync(timeZone) {
        ...
        const timeZoneCFM = await this.connection.sendFrameAsync(new GW_RTC_SET_TIME_ZONE_REQ_js_1.GW_RTC_SET_TIME_ZONE_REQ(timeZone));
        if (timeZoneCFM.Status !== common_js_1.GW_INVERSE_STATUS.SUCCESS)
    ...
    async rebootAsync() {
        ...
        await this.connection.sendFrameAsync(new GW_REBOOT_REQ_js_1.GW_REBOOT_REQ());
    }
    /**
    ...
    async factoryResetAsync() {
        ...
        await this.connection.sendFrameAsync(new GW_SET_FACTORY_DEFAULT_REQ_js_1.GW_SET_FACTORY_DEFAULT_REQ());
    }
    /**
    ...
    async leaveLearnStateAsync() {
        ...
        await this.connection.sendFrameAsync(new GW_LEAVE_LEARN_STATE_REQ_js_1.GW_LEAVE_LEARN_STATE_REQ());
    }
    /**
    ...
    async getNetworkSettingsAsync() {
        ...
        const networkSettings = await this.connection.sendFrameAsync(new GW_GET_NETWORK_SETUP_REQ_js_1.GW_GET_NETWORK_SETUP_REQ());
        return {
    ...
    async setNetworkSettingsAsync(DHCP, IPAddress, Mask, DefaultGateway) {
        debug(`Setting network settings to DHCP=${DHCP}, IPAddress=${IPAddress}, Mask=${Mask}, DefaultGateway=${DefaultGateway}.`);
        if (DHCP) {
            IPAddress = Mask = DefaultGateway = "0.0.0.0";
        }
        await this.connection.sendFrameAsync(new GW_SET_NETWORK_SETUP_REQ_js_1.GW_SET_NETWORK_SETUP_REQ(DHCP, IPAddress, Mask, DefaultGateway));
    }
    /**
    ...
    async enableHouseStatusMonitorAsync() {
        ...
        await this.connection.sendFrameAsync(new GW_HOUSE_STATUS_MONITOR_ENABLE_REQ_js_1.GW_HOUSE_STATUS_MONITOR_ENABLE_REQ());
    }
    /**
    ...
    async disableHouseStatusMonitorAsync() {
        ...
        await this.connection.sendFrameAsync(new GW_HOUSE_STATUS_MONITOR_DISABLE_REQ_js_1.GW_HOUSE_STATUS_MONITOR_DISABLE_REQ());
    }
}
