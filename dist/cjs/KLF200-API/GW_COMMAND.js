...
exports.ActivateProductGroupStatus = exports.ModeStatus = exports.LimitationType = exports.StatusType = exports.StatusReply = exports.RunStatus = exports.StatusOwner = exports.CommandStatus = exports.LockTime = exports.PriorityLevelInformation = exports.PriorityLevelLock = exports.ParameterActive = exports.PriorityLevel = exports.CommandOriginator = void 0;
...
})(CommandOriginator || (exports.CommandOriginator = CommandOriginator = {}));
var PriorityLevel;
...
})(ParameterActive || (exports.ParameterActive = ParameterActive = {}));
...
})(PriorityLevelLock || (exports.PriorityLevelLock = PriorityLevelLock = {}));
...
})(PriorityLevelInformation || (exports.PriorityLevelInformation = PriorityLevelInformation = {}));
class LockTime {
    ...
    static lockTimeValueToLockTimeForLimitation(lockTimeValue) {
        // Check parameter range
        if (lockTimeValue < 0 || lockTimeValue > 253)
            throw new Error("Lock time value out of range.");
        return lockTimeValue === 253 ? Infinity : lockTimeValue * 30 + 30;
    }
    static lockTimeTolockTimeValueForLimitation(lockTime) {
        if (lockTime === Infinity)
            return 253;
        if (lockTime % 30 !== 0)
            throw new Error("Lock time must be a multiple of 30.");
...
})(StatusOwner || (exports.StatusOwner = StatusOwner = {}));
var RunStatus;
(function (RunStatus) {
...
})(StatusReply || (exports.StatusReply = StatusReply = {}));
var StatusType;
(function (StatusType) {
...
})(LimitationType || (exports.LimitationType = LimitationType = {}));
var ModeStatus;
(function (ModeStatus) {
...
})(ModeStatus || (exports.ModeStatus = ModeStatus = {}));
...
})(ActivateProductGroupStatus || (exports.ActivateProductGroupStatus = ActivateProductGroupStatus = {}));
const InverseProductTypes = [
    GW_SYSTEMTABLE_DATA_js_1.ActuatorType.WindowOpener,
    GW_SYSTEMTABLE_DATA_js_1.ActuatorType.Light,
    GW_SYSTEMTABLE_DATA_js_1.ActuatorType.OnOffSwitch,
    GW_SYSTEMTABLE_DATA_js_1.ActuatorType.VentilationPoint,
    GW_SYSTEMTABLE_DATA_js_1.ActuatorType.ExteriorHeating,
];
