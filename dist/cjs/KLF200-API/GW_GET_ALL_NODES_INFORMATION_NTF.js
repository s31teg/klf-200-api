...
exports.GW_GET_ALL_NODES_INFORMATION_NTF = void 0;
const common_js_1 = require("./common.js");
const GW_SYSTEMTABLE_DATA_js_1 = require("./GW_SYSTEMTABLE_DATA.js");
class GW_GET_ALL_NODES_INFORMATION_NTF extends common_js_1.GW_FRAME_NTF {
    NodeID;
    Order;
    Placement;
    Name;
    ...
    constructor(Data) {
        ...
        const actuatorTypes = (0, GW_SYSTEMTABLE_DATA_js_1.splitActuatorType)(this.Data.readUInt16BE(69));
        ...
        for (let index = 0; index < numberOfAliases; index++) {
            const alias = new GW_SYSTEMTABLE_DATA_js_1.ActuatorAlias(this.Data.readUInt16BE(index * 4 + 104), this.Data.readUInt16BE(index * 4 + 106));
