...
exports.GW_MODE_SEND_REQ = void 0;
const common_js_1 = require("./common.js");
const GW_COMMAND_js_1 = require("./GW_COMMAND.js");
class GW_MODE_SEND_REQ extends common_js_1.GW_FRAME_COMMAND_REQ {
    Nodes;
    ModeNumber;
    ModeParameter;
    PriorityLevel;
    ...
    constructor(Nodes, ModeNumber = 0, ModeParameter = 0, PriorityLevel = 3, CommandOriginator = 1, PriorityLevelLock = 0, PriorityLevels = [], LockTime = Infinity) {
        ...
        buff.writeUInt8(GW_COMMAND_js_1.LockTime.lockTimeTolockTimeValue(this.LockTime), 30);
    }
}
