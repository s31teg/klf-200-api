...
exports.GW_ACTIVATE_PRODUCTGROUP_REQ = void 0;
const common_js_1 = require("./common.js");
const GW_COMMAND_js_1 = require("./GW_COMMAND.js");
class GW_ACTIVATE_PRODUCTGROUP_REQ extends common_js_1.GW_FRAME_COMMAND_REQ {
    GroupID;
    Position;
    PriorityLevel;
    CommandOriginator;
    ...
    constructor(GroupID, Position, PriorityLevel = 3, CommandOriginator = 1, ParameterActive = 0, Velocity = 0, PriorityLevelLock = 0, PriorityLevels = [], LockTime = Infinity) {
        ...
        buff.writeUInt8(GW_COMMAND_js_1.LockTime.lockTimeTolockTimeValue(this.LockTime), 12);
    }
}
