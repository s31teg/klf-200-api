...
exports.GW_SET_CONTACT_INPUT_LINK_REQ = void 0;
const common_js_1 = require("./common.js");
const GW_COMMAND_js_1 = require("./GW_COMMAND.js");
class GW_SET_CONTACT_INPUT_LINK_REQ extends common_js_1.GW_FRAME_REQ {
    ContactInputID;
    ...
    PLI6;
    PLI7;
    constructor(ContactInputID, ContactInputAssignment, SuccessOutputID, ErrorOutputID, Position, Velocity = 0, ActionID, PriorityLevel = 3, CommandOriginator = 1, ParameterActive = 0, LockPriorityLevel = 0, PLI3 = GW_COMMAND_js_1.PriorityLevelInformation.KeepCurrent, PLI4 = GW_COMMAND_js_1.PriorityLevelInformation.KeepCurrent, PLI5 = GW_COMMAND_js_1.PriorityLevelInformation.KeepCurrent, PLI6 = GW_COMMAND_js_1.PriorityLevelInformation.KeepCurrent, PLI7 = GW_COMMAND_js_1.PriorityLevelInformation.KeepCurrent) {
        super(17);
