...
exports.SLIPProtocol = exports.SLIP_END = exports.KLF200Protocol = exports.GW_FRAME_NTF = exports.GW_FRAME_CFM = exports.GW_FRAME_RCV = exports.GW_FRAME_COMMAND_REQ = exports.GW_FRAME_REQ = exports.GW_FRAME = exports.C_MAX_PWD_LENGTH = exports.GW_INVERSE_STATUS = exports.GW_COMMON_STATUS = exports.GatewayCommand = exports.KLF200_PORT = void 0;
...
(function (GatewayCommand) {
    ...
    GatewayCommand[GatewayCommand["GW_PASSWORD_CHANGE_NTF"] = 12292] = "GW_PASSWORD_CHANGE_NTF";
})(GatewayCommand || (exports.GatewayCommand = GatewayCommand = {}));
...
})(GW_COMMON_STATUS || (exports.GW_COMMON_STATUS = GW_COMMON_STATUS = {}));
...
})(GW_INVERSE_STATUS || (exports.GW_INVERSE_STATUS = GW_INVERSE_STATUS = {}));
const C_COMMAND_SIZE = 2;
const C_BUFFERLEN_SIZE = 1;
exports.C_MAX_PWD_LENGTH = 32;
class GW_FRAME {
    Command = GatewayCommand[this.constructor.name];
    offset = C_BUFFERLEN_SIZE + C_COMMAND_SIZE;
    constructor() { }
}
...
class GW_FRAME_COMMAND_REQ extends GW_FRAME_REQ {
    ...
    constructor(BufferSize) {
        super(BufferSize);
        this.SessionID = (0, GW_COMMAND_js_1.getNextSessionID)();
    }
}
